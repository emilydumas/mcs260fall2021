...
(number of words, most common word, etc.) to JSON file"""
# MCS 260 Fall 2021 - post-lecture 15
...
# Build a dictionary containing everything we want to save
# to the output file
report = {
    "filename": fn,
    "words": wordcount,
    "distinct_words": len(word_histogram),
    "max_words_per_line": max_words_per_line,
    "most_used_words": most_frequent_words,
    "most_used_words_freq": maxcount,
    "most_used_words_percent":  100.0*maxcount/wordcount
}

# Open the output file and write the report to it
